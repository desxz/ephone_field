...
void main() {
  ...
  testWidgets(
    'should CountryPickerButton widget renders flag image by default',
    (widgetTester) async {
      await widgetTester.pumpWidget(mockWidget);
  ...
  testWidgets(
    ...
    (widgetTester) async {
      mockWidget = CountryPickerButtonMock(
        menuType: PickerMenuType.dialog,
        pickerHeight: CountryPickerHeight.h25,
      );
      await widgetTester.pumpWidget(mockWidget);
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      final CountryPickerMenu menu = widgetTester.firstWidget(
        find.byType(CountryPickerMenu),
      );
      expect(menu.height, mockWidget.ctx!.size!.height * .25);
    },
  );
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      expect(menu.height, mockWidget.ctx!.size!.height * .50);
    },
  );
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      expect(menu.height, mockWidget.ctx!.size!.height * .75);
    },
  );
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      expect(menu.height, mockWidget.ctx!.size!.height);
    },
  );
}
