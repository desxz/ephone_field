...
class EphonePhoneBindings {
  ...
  late final _ephone_phone_util_create = _ephone_phone_util_createPtr
  ...
  late final _ephone_phone_util_destroy = _ephone_phone_util_destroyPtr
  ...
  late final _ephone_phone_is_validPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Char>)>>('ephone_phone_is_valid');
  late final _ephone_phone_is_valid = _ephone_phone_is_validPtr.asFunction<
      int Function(ffi.Pointer<EphonePhoneUtil>, ffi.Pointer<ffi.Char>,
          ffi.Pointer<ffi.Char>)>();
  ...
  late final _ephone_phone_is_possiblePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<EphonePhoneUtil>,
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>)>>('ephone_phone_is_possible');
  late final _ephone_phone_is_possible =
      _ephone_phone_is_possiblePtr.asFunction<
          int Function(ffi.Pointer<EphonePhoneUtil>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>)>();
  ...
  late final _ephone_phone_format_e164Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>,
              ffi.Int32)>>('ephone_phone_format_e164');
  late final _ephone_phone_format_e164 =
      _ephone_phone_format_e164Ptr.asFunction<
          int Function(ffi.Pointer<EphonePhoneUtil>, ffi.Pointer<ffi.Char>,
  ...
  late final _ephone_phone_format_nationalPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>,
              ffi.Int32)>>('ephone_phone_format_national');
  late final _ephone_phone_format_national =
      _ephone_phone_format_nationalPtr.asFunction<
          int Function(ffi.Pointer<EphonePhoneUtil>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _ephone_asyoutype_createPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<EphoneAsYouType> Function(ffi.Pointer<EphonePhoneUtil>,
              ffi.Pointer<ffi.Char>)>>('ephone_asyoutype_create');
  late final _ephone_asyoutype_create = _ephone_asyoutype_createPtr.asFunction<
      ffi.Pointer<EphoneAsYouType> Function(
          ffi.Pointer<EphonePhoneUtil>, ffi.Pointer<ffi.Char>)>();
  ...
  late final _ephone_asyoutype_destroy = _ephone_asyoutype_destroyPtr
  ...
  late final _ephone_asyoutype_input_digit =
      _ephone_asyoutype_input_digitPtr.asFunction<
          int Function(
              ffi.Pointer<EphoneAsYouType>, int, ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _ephone_asyoutype_clear = _ephone_asyoutype_clearPtr
      .asFunction<void Function(ffi.Pointer<EphoneAsYouType>)>();
